    ...
    public static final Supplier<CreativeModeTab> BLOOM_AND_DOOM_BLOCKS_TAB = CREATIVE_MODE_TAB.register("bloom_and_doom_blocks_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(BnDBlocks.PLANTER.get()))
                    ...
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(BnDBlocks.PLASTIC_ORE);

                        output.accept(BnDBlocks.WHITE_PLASTIC_BLOCK);
                        output.accept(BnDBlocks.WHITE_PLASTIC_STAIRS);
                        output.accept(BnDBlocks.WHITE_PLASTIC_SLAB);
                        output.accept(BnDBlocks.WHITE_PLASTIC_WALL);
                        output.accept(BnDBlocks.WHITE_TRAFFIC_CONE);
                        output.accept(BnDBlocks.LIGHT_GRAY_PLASTIC_BLOCK);
                        output.accept(BnDBlocks.LIGHT_GRAY_PLASTIC_STAIRS);
                        output.accept(BnDBlocks.LIGHT_GRAY_PLASTIC_SLAB);
                        output.accept(BnDBlocks.LIGHT_GRAY_PLASTIC_WALL);
                        output.accept(BnDBlocks.LIGHT_GRAY_TRAFFIC_CONE);
                        output.accept(BnDBlocks.GRAY_PLASTIC_BLOCK);
                        output.accept(BnDBlocks.GRAY_PLASTIC_STAIRS);
                        output.accept(BnDBlocks.GRAY_PLASTIC_SLAB);
                        output.accept(BnDBlocks.GRAY_PLASTIC_WALL);
                        output.accept(BnDBlocks.GRAY_TRAFFIC_CONE);
                        output.accept(BnDBlocks.BLACK_PLASTIC_BLOCK);
                        output.accept(BnDBlocks.BLACK_PLASTIC_STAIRS);
                        output.accept(BnDBlocks.BLACK_PLASTIC_SLAB);
                        output.accept(BnDBlocks.BLACK_PLASTIC_WALL);
                        output.accept(BnDBlocks.BLACK_TRAFFIC_CONE);
                        output.accept(BnDBlocks.BROWN_PLASTIC_BLOCK);
                        output.accept(BnDBlocks.BROWN_PLASTIC_STAIRS);
                        output.accept(BnDBlocks.BROWN_PLASTIC_SLAB);
                        output.accept(BnDBlocks.BROWN_PLASTIC_WALL);
                        output.accept(BnDBlocks.BROWN_TRAFFIC_CONE);
                        output.accept(BnDBlocks.RED_PLASTIC_BLOCK);
                        output.accept(BnDBlocks.RED_PLASTIC_STAIRS);
                        output.accept(BnDBlocks.RED_PLASTIC_SLAB);
                        output.accept(BnDBlocks.RED_PLASTIC_WALL);
                        output.accept(BnDBlocks.RED_TRAFFIC_CONE);
                        output.accept(BnDBlocks.ORANGE_PLASTIC_BLOCK);
                        output.accept(BnDBlocks.ORANGE_PLASTIC_STAIRS);
                        output.accept(BnDBlocks.ORANGE_PLASTIC_SLAB);
                        output.accept(BnDBlocks.ORANGE_PLASTIC_WALL);
                        output.accept(BnDBlocks.ORANGE_TRAFFIC_CONE);
                        output.accept(BnDBlocks.YELLOW_PLASTIC_BLOCK);
                        output.accept(BnDBlocks.YELLOW_PLASTIC_STAIRS);
                        output.accept(BnDBlocks.YELLOW_PLASTIC_SLAB);
                        output.accept(BnDBlocks.YELLOW_PLASTIC_WALL);
                        output.accept(BnDBlocks.YELLOW_TRAFFIC_CONE);
                        output.accept(BnDBlocks.LIME_PLASTIC_BLOCK);
                        output.accept(BnDBlocks.LIME_PLASTIC_STAIRS);
                        output.accept(BnDBlocks.LIME_PLASTIC_SLAB);
                        output.accept(BnDBlocks.LIME_PLASTIC_WALL);
                        output.accept(BnDBlocks.LIME_TRAFFIC_CONE);
                        output.accept(BnDBlocks.GREEN_PLASTIC_BLOCK);
                        output.accept(BnDBlocks.GREEN_PLASTIC_STAIRS);
                        output.accept(BnDBlocks.GREEN_PLASTIC_SLAB);
                        output.accept(BnDBlocks.GREEN_PLASTIC_WALL);
                        output.accept(BnDBlocks.GREEN_TRAFFIC_CONE);
                        output.accept(BnDBlocks.CYAN_PLASTIC_BLOCK);
                        output.accept(BnDBlocks.CYAN_PLASTIC_STAIRS);
                        output.accept(BnDBlocks.CYAN_PLASTIC_SLAB);
                        output.accept(BnDBlocks.CYAN_PLASTIC_WALL);
                        output.accept(BnDBlocks.CYAN_TRAFFIC_CONE);
                        output.accept(BnDBlocks.LIGHT_BLUE_PLASTIC_BLOCK);
                        output.accept(BnDBlocks.LIGHT_BLUE_PLASTIC_STAIRS);
                        output.accept(BnDBlocks.LIGHT_BLUE_PLASTIC_SLAB);
                        output.accept(BnDBlocks.LIGHT_BLUE_PLASTIC_WALL);
                        output.accept(BnDBlocks.LIGHT_BLUE_TRAFFIC_CONE);
                        output.accept(BnDBlocks.BLUE_PLASTIC_BLOCK);
                        output.accept(BnDBlocks.BLUE_PLASTIC_STAIRS);
                        output.accept(BnDBlocks.BLUE_PLASTIC_SLAB);
                        output.accept(BnDBlocks.BLUE_PLASTIC_WALL);
                        output.accept(BnDBlocks.BLUE_TRAFFIC_CONE);
                        output.accept(BnDBlocks.PURPLE_PLASTIC_BLOCK);
                        output.accept(BnDBlocks.PURPLE_PLASTIC_STAIRS);
                        output.accept(BnDBlocks.PURPLE_PLASTIC_SLAB);
                        output.accept(BnDBlocks.PURPLE_PLASTIC_WALL);
                        output.accept(BnDBlocks.PURPLE_TRAFFIC_CONE);
                        output.accept(BnDBlocks.MAGENTA_PLASTIC_BLOCK);
                        output.accept(BnDBlocks.MAGENTA_PLASTIC_STAIRS);
                        output.accept(BnDBlocks.MAGENTA_PLASTIC_SLAB);
                        output.accept(BnDBlocks.MAGENTA_PLASTIC_WALL);
                        output.accept(BnDBlocks.MAGENTA_TRAFFIC_CONE);
                        output.accept(BnDBlocks.PINK_PLASTIC_BLOCK);
                        output.accept(BnDBlocks.PINK_PLASTIC_STAIRS);
                        output.accept(BnDBlocks.PINK_PLASTIC_SLAB);
                        output.accept(BnDBlocks.PINK_PLASTIC_WALL);
                        output.accept(BnDBlocks.PINK_TRAFFIC_CONE);
