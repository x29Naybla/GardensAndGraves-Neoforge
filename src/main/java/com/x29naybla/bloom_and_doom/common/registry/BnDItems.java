...
import static com.x29naybla.bloom_and_doom.common.tag.BnDTags.BannerPatterns.BRAINZ;
...
public class BnDItems {
    ...
    public static final DeferredItem<Item> MUSIC_DISC_WABBY_WABBO = ITEMS.register("music_disc_wabby_wabbo",
            () -> new Item(new Item.Properties().rarity(Rarity.RARE).jukeboxPlayable(BnDSounds.WABBY_WABBO_KEY).stacksTo(1)));
    ...
    public static final DeferredItem<SpawnEggItem> ZOMBIE_WOLF_SPAWN_EGG = ITEMS.register("zombie_wolf_spawn_egg",
            () -> new DeferredSpawnEggItem(BnDEntities.ZOMBIE_WOLF, 14144467, 7969893, new Item.Properties()));
