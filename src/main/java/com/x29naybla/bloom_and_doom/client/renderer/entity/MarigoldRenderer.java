...
import com.x29naybla.bloom_and_doom.client.model.entity.MarigoldModel;
...
public class MarigoldRenderer extends GeoEntityRenderer<MarigoldEntity> {
    ...
    @Override
    public void render(MarigoldEntity animatable, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
