...
public class ZombieBanner {
    ...
    public static ItemStack getZombieLeaderBannerInstance(HolderGetter<BannerPattern> patternRegistry) {
        ...
        BannerPatternLayers bannerpatternlayers = (new BannerPatternLayers.Builder()).addIfRegistered(patternRegistry, ResourceKey.create(Registries.BANNER_PATTERN, ResourceLocation.fromNamespaceAndPath(GardensAndGraves.MOD_ID,"brainz")), DyeColor.PINK).build();
